    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100 pt-24">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="text-center mb-16">
          ...
          <h1 className="text-5xl sm:text-6xl lg:text-7xl inter-bold bg-gradient-to-r from-slate-800 via-blue-800 to-purple-900 bg-clip-text text-transparent leading-tight mb-6">
            My Applications
          </h1>
          <p className="text-slate-600 text-xl sm:text-2xl mt-4 max-w-3xl mx-auto leading-relaxed inter-light">
            Track your team applications and their status in real-time
          </p>
          <div className="inline-flex items-center bg-gradient-to-r from-blue-100 to-indigo-100 border border-blue-200 text-blue-700 px-6 py-3 rounded-full text-lg inter-medium mt-6 shadow-lg">
      ...
      {applications.length === 0 ? (
        <div className="bg-white/80 backdrop-blur-xl rounded-3xl shadow-2xl border border-white/60 p-16 text-center max-w-2xl mx-auto">
          ...
          <h3 className="text-3xl inter-bold text-slate-800 mb-6">No Applications Yet</h3>
          <p className="text-slate-600 text-xl mb-10 max-w-lg mx-auto leading-relaxed inter-regular">
            You haven't applied to any teams yet. Browse available teams to find exciting projects to join and start collaborating!
          </p>
          <a
            href="/teams"
            className="inline-flex items-center bg-gradient-to-r from-blue-500 via-indigo-500 to-purple-600 hover:from-blue-600 hover:via-indigo-600 hover:to-purple-700 text-white px-10 py-4 rounded-2xl transition-all duration-300 transform hover:scale-105 inter-semibold shadow-xl text-lg"
          >
          ...
          {applications.map((team) => (
            <div key={team.id} className="group bg-white/80 backdrop-blur-xl rounded-3xl shadow-2xl border border-white/60 p-8 hover:shadow-3xl transition-all duration-500 transform hover:-translate-y-2 border-l-8 border-l-gradient-to-b from-amber-400 to-orange-500 overflow-hidden relative">
              ...
              <div className="relative z-10 flex flex-col xl:flex-row xl:justify-between xl:items-start mb-8 gap-6">
                <div className="flex-grow">
                  <div className="flex items-center mb-4">
                    ...
                    <span className="text-sm inter-semibold text-amber-600 uppercase tracking-wider">Application Pending</span>
                  </div>
                  <h3 className="text-3xl inter-bold text-slate-800 mb-6 group-hover:text-slate-900 transition-colors duration-300 leading-tight">{team.title}</h3>
                  <div className="flex flex-wrap gap-3">
                    <span className="inline-flex items-center bg-gradient-to-r from-blue-500 to-indigo-600 text-white text-sm px-5 py-2 rounded-full inter-semibold shadow-lg">
                ...
                <div className="xl:text-right bg-gradient-to-br from-slate-50/80 to-slate-100/80 backdrop-blur-sm rounded-2xl p-6 min-w-[240px] border border-slate-200/50">
                  <div className="text-sm text-slate-500 mb-1 inter-medium">Applied on</div>
                  <div className="text-xl inter-bold text-slate-800 mb-3">{formatDate(team.createdAt)}</div>
                  <div className="flex items-center justify-center xl:justify-end">
                    <div className="bg-gradient-to-r from-emerald-500 to-green-600 text-white px-4 py-2 rounded-full text-sm inter-semibold">
                      <span className="inter-bold">{team.currentMembers}/{team.teamSize}</span> members
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="relative z-10 mb-8 bg-gradient-to-br from-slate-50/80 to-slate-100/80 backdrop-blur-sm rounded-2xl p-6 border border-slate-200/50">
                <h4 className="text-sm inter-bold text-slate-600 uppercase tracking-wider mb-3 flex items-center">
                  <svg className="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                  </svg>
                  Project Description
                </h4>
                <p className="text-slate-700 leading-relaxed text-lg inter-medium">
                  {team.description}
                </p>
              </div>
              ...
              <div className="relative z-10 mb-8">
                <h4 className="text-sm inter-bold text-slate-600 uppercase tracking-wider mb-4 flex items-center">
                  <svg className="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div className="flex flex-wrap gap-3">
                  {team.skillsNeeded.map((skill, index) => (
                    <span key={index} className="bg-gradient-to-r from-purple-100 via-blue-100 to-indigo-100 text-purple-800 text-sm px-5 py-3 rounded-full inter-semibold border border-purple-200 shadow-sm">
                      {skill}
                    </span>
                  ))}
                </div>
                ...
                <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
                  {team.members.map((member, index) => (
                    <div key={index} className="flex items-center bg-gradient-to-r from-slate-50/80 to-slate-100/80 backdrop-blur-sm p-4 rounded-2xl border border-slate-200/50 hover:shadow-lg transition-all duration-300">
                      <div className="w-12 h-12 bg-gradient-to-r from-emerald-400 via-blue-500 to-purple-600 rounded-full flex items-center justify-center text-white inter-bold text-lg mr-4 shadow-lg">
                        {(member.name || 'U').charAt(0).toUpperCase()}
                      </div>
                      <div className="flex-grow">
                        <span className="inter-bold text-slate-800 block text-lg">{member.name}</span>
                        <span className="text-slate-600 text-sm inter-medium">{member.role}</span>
                      </div>
                    </div>
                  ))}
                </div>
              ...
              <div className="relative z-10 bg-gradient-to-br from-blue-50/80 via-indigo-50/80 to-purple-50/80 backdrop-blur-sm p-8 rounded-2xl mb-8 border border-blue-200/50 shadow-lg">
                <h4 className="text-lg inter-bold text-slate-700 mb-6 text-center">Application Analytics</h4>
                <div className="grid sm:grid-cols-3 gap-6">
                  <div className="text-center group">
                    ...
                    <span className="text-sm inter-bold text-slate-600 uppercase tracking-wider block mb-2">Total Applications</span>
                    <p className="text-3xl inter-bold text-blue-600 mb-1">{team.applications?.length || 0}</p>
                    <p className="text-sm text-slate-500 inter-medium">pending review</p>
                  </div>
                  <div className="text-center group">
                    ...
                    <span className="text-sm inter-bold text-slate-600 uppercase tracking-wider block mb-2">Spots Available</span>
                    <p className="text-3xl inter-bold text-emerald-600 mb-1">{team.teamSize - team.currentMembers}</p>
                    <p className="text-sm text-slate-500 inter-medium">positions open</p>
                  </div>
                  <div className="text-center group">
                    ...
                    <span className="text-sm inter-bold text-slate-600 uppercase tracking-wider block mb-2">Competition Level</span>
                    <p className="text-3xl inter-bold text-purple-600 mb-1">
                      {team.applications?.length > 1 ? team.applications.length - 1 : 0}
                    </p>
                    <p className="text-sm text-slate-500 inter-medium">
              ...
              <div className="relative z-10 flex flex-col lg:flex-row lg:justify-between lg:items-center pt-8 border-t border-slate-200/50 gap-6">
                <div className="flex items-center bg-gradient-to-r from-amber-50 to-orange-50 px-6 py-4 rounded-xl border border-amber-200/50 shadow-sm">
                  ...
                  <div>
                    <span className="text-sm inter-bold text-slate-600 uppercase tracking-wider">Status:</span>
                    <span className="text-amber-600 inter-bold ml-3 text-lg">Awaiting Team Response</span>
                  </div>
                </div>
                <button
                  onClick={() => withdrawApplication(team.id, team.title)}
                  disabled={actionLoading === team.id}
                  className={`px-8 py-4 text-sm inter-bold rounded-2xl transition-all duration-300 transform hover:scale-105 shadow-xl ${
      ...
      {applications.length > 0 && (
        <div className="mt-16 bg-white/80 backdrop-blur-xl rounded-3xl shadow-2xl border border-white/60 p-10">
          <h3 className="text-3xl inter-bold mb-8 text-center bg-gradient-to-r from-slate-800 to-slate-600 bg-clip-text text-transparent">Quick Actions</h3>
          <div className="grid lg:grid-cols-2 gap-8">
            ...
            >
              ...
              <div className="relative z-10">
                ...
                <h4 className="inter-bold text-slate-800 mb-3 text-xl">Discover More Teams</h4>
                <p className="text-slate-600 leading-relaxed text-lg inter-regular">Explore exciting new projects and find the perfect team to match your skills and interests.</p>
              </div>
            </a>
            <a
              href="/create-team"
            ...
            >
              ...
              <div className="relative z-10">
                ...
                <h4 className="inter-bold text-slate-800 mb-3 text-xl">Start Your Own Project</h4>
                <p className="text-slate-600 leading-relaxed text-lg inter-regular">Create a new team, define your vision, and recruit talented individuals to bring your ideas to life.</p>
              </div>
            </a>
          </div>
        </div>
